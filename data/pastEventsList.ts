export const pastEventsList = [
    {
        id: 1,
        image: '/assets/past-events/sit-2024.png',
        eventName: 'Random Event',
        title: `SIT 2024`,
        desc: `simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when 
    ...
    {
        id: 2,
        image: '/assets/past-events/sit-2025.png',
        eventName: 'Random Event',
        title: `SIT 2025`,
        desc: `simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when 
        an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic 
